...
- При запуске асинхронной операции ввода-вывода, поток продолжает обрабатывать другие операции, пока ядро не отправит сигнал потоку, указывая, что асинхронная операция вводавывода завершена.
